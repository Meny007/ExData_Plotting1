# This script reads the data from UC Irvine Machine Learning Repository, a dataset called Electrical Power consumption. The aim # of this project is to reproduce the 4 plots in the project. Plot 1 is the first plot to be reproduced.
...
#Constructing Plot 1 and saving it in png format
par(mfrow=c(1,1),mar=c(4,4,2,1),oma=c(0,0,2,0))
hist(epc.sub$Global_active_power,col="red",main="Global Active Power", xlab="Global Active Power (kilowatts)")
