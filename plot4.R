# This script reads the data from UC Irvine Machine Learning Repository, a dataset called Electrical Power consumption. The aim # of this project is to reproduce the 4 plots in the project. Plot 4 is the 4th plot to be reproduced.
...
plot(epc.sub$datetime,epc.sub$Global_active_power,type="l",xlab="", ylab="Global Active Power")
plot(epc.sub$datetime,epc.sub$Voltage,type="l",xlab="datetime", ylab="Voltage")
...
plot(epc.sub$datetime,epc.sub$Global_reactive_power,type="l",xlab="datetime", ylab="Global_reactive_power")
